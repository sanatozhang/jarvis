...
const EN: Record<string, string> = {
  ...
  "近 1 年": "Last 1 yr",
  "统计区间": "Range",
  "上周汇总": "Last week's digest",
  "当前窗口未结束，周报固定展示最近一个完整周": "The selected window isn't over yet — the digest always shows the most recently completed week",
  ...
  "重新生成": "Regenerate",
  "该周暂无周报，点击「重新生成」创建。": "No digest for this week yet — click Regenerate to create one.",
